    ...
    public class FilePackageGenerator : IProgressNotificationsDispatcher
    {
        ...
        private void Generate( Context.GlobalInfo globalInfo, Context.PackageInfo packageInfo, Results results )
        {
            ...
            try
            {
                ...
                using (FileStream file = new FileStream(packageInfo.FilePackageFilename, FileMode.Create))
                {
                    ...
                    {
                        case AK.Wwise.InfoFile.SoundBanksInfoBasePlatform.PS3:
                        case AK.Wwise.InfoFile.SoundBanksInfoBasePlatform.Wii:
                        case AK.Wwise.InfoFile.SoundBanksInfoBasePlatform.Xbox360:
                        case AK.Wwise.InfoFile.SoundBanksInfoBasePlatform.WiiUSW:
                        case AK.Wwise.InfoFile.SoundBanksInfoBasePlatform.WiiUHW:
            ...
            Results results)
        {
            ...
            switch (globalInfo.BasePlatform)
            {
                ...
                case AK.Wwise.InfoFile.SoundBanksInfoBasePlatform.XboxSeriesX:
            ...
            foreach (AK.Wwise.InfoFile.FileDescriptorType stream in descriptors.Where( fd => ( fd is AK.Wwise.InfoFile.StreamedFileDescriptorType ||
        ...
        static internal Dictionary<string, uint> FindAllLanguages(IEnumerable<AK.Wwise.InfoFile.FileDescriptorType> descriptors )
        {
            ...
            // Search languages in streamed filess
            foreach (AK.Wwise.InfoFile.FileDescriptorType streamedFile in descriptors.Where(fd => (fd is AK.Wwise.InfoFile.StreamedFileDescriptorType ||
                                                                                                   fd is AK.Wwise.InfoFile.SoundBanksInfoMediaFilesNotInAnyBankFile ) ) )
            {
