...
namespace AK.Wwise.Waapi
{
    ...
    public class Wamp
    {
        ...
        private System.Collections.Concurrent.ConcurrentDictionary<int, PublishHandler> subscriptions = new System.Collections.Concurrent.ConcurrentDictionary<int, PublishHandler>();
            ...
            var task = System.Threading.Tasks.Task.Factory.StartNew(() =>
            {
                ...
                while (true)
                {
                    ...
                    catch(System.Exception e)
                    {
                        ...
                        // Signal the exception to the other thread and continue to listent
