...
void Demo3dBus::Init_CoupledRoomsSimple()
{
	...
	m_szHelp =
		...
		"reverb Effect, after which the output is positioned and spatialized, before being mixed in the "
		"Master Audio Bus. \n"
		"Controls: \n"
...
void Demo3dBus::Init_3dSubmix()
{
	...
	m_szHelp =
		...
		"'Position + Orientation' selected and an attenuation assigned. The sound engine applies spatialization "
