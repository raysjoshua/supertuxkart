...
bool DemoMarkers::Init()
{
	...
	if ( AK::SoundEngine::LoadBank( "MarkerTest.bnk", bankID ) != AK_Success )
	{
...
void DemoMarkers::Draw()
{
	...
	if ( m_bPlayingMarkers )
	{
		...
		DrawTextOnScreen( m_strCurrentLine.c_str(), iSubX, iSubY, DrawStyle_Text );
	}
}
