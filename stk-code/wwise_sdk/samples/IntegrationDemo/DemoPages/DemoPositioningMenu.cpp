...
void DemoPositioningMenu::InitControls()
{
	...
	newBtn = new ButtonControl(*this);
	newBtn->SetLabel("Spatial Audio - Portals and Geometry");
	newBtn->SetDelegate((PageMFP)&DemoPositioningMenu::Scenario_PortalsGeometry_Pressed);
	m_Controls.push_back(newBtn);

	newBtn = new ButtonControl(*this);
	newBtn->SetLabel("Spatial Audio - Geometry");
	newBtn->SetDelegate((PageMFP)&DemoPositioningMenu::Scenario_Geometry_Pressed);
	m_Controls.push_back(newBtn);
...
void DemoPositioningMenu::Scenario_Portals_Pressed(void*, ControlEvent*)
{
	DemoSpatialAudio* pg = new DemoSpatialAudio(*m_pParentMenu, Scenario_Portals);
	m_pParentMenu->StackPage(pg);
}

void DemoPositioningMenu::Scenario_PortalsGeometry_Pressed(void* in_pSender, ControlEvent* in_pEvent)
{
	DemoSpatialAudio* pg = new DemoSpatialAudio(*m_pParentMenu, Scenario_Portals_And_Geometry);
	m_pParentMenu->StackPage(pg);
}

void DemoPositioningMenu::Scenario_Geometry_Pressed(void*, ControlEvent*)
{
