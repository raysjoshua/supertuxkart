...
private:
	...
	static const AkGameObjectID OBJ_FOR_PLAYER[UG_MAX_GAMEPADS];		
	AkOutputDeviceID m_PlayerAudioOutput[UG_MAX_GAMEPADS];
	AkOutputDeviceID m_PlayerMotionOutput[UG_MAX_GAMEPADS];
};
