...
typedef CAkFilePackageLowLevelIODeferred LowLevelIOSystem;
#else
class CAkFilePackageLowLevelIOBlocking;
typedef CAkFilePackageLowLevelIOBlocking LowLevelIOSystem;
#endif
...
public:
	...
	LowLevelIOSystem* GetLowLevelIOHandler() { return m_pLowLevelIO; }
...
private:
	...
	LowLevelIOSystem* m_pLowLevelIO;
