...
enum UGThumbstick { UG_STICKLEFT = 0, UG_STICKRIGHT = 1, UG_STICKCOUNT };
...
/// The maximum number of gamepads supported at one time. (e.g. for multiplayer demo pages)
...
enum UGDeviceType
{
	...
	UGDeviceType_GAMEPAD,			//< Default GamePad device
};
