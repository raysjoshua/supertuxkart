...
protected:
	...
	/// Toggle ON/OFF the resources monitor summary.
...
private:
	...
	/// Is 'true' when the resources monitor is displayed. Is static to keep the same value from page to page.
	static bool ToggledResourceMonitor;
};
