...
public:
	...
	/// Forcefully sets currently selected option to this index.
	/// It will not call a delegate, so it is advised to use this during, e.g., initialization of the Control.
