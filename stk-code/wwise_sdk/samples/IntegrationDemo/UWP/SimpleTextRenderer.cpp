...
void SimpleTextRenderer::DrawText( WCHAR * in_szText, int in_eTextType, int in_eColor, int in_X, int in_Y )
{
	...
	m_deviceResources->GetD2DDeviceContext()->DrawText( in_szText, static_cast<UINT32>(wcslen( in_szText )), m_textFormat[ in_eTextType ].Get(), rect, m_textBrush[ in_eColor ].Get() );
}
