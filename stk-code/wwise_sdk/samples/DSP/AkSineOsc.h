...
namespace AK
{
	namespace DSP
	{
		static const AkReal32 fTWOPI	= 6.2831853f;
		static const AkReal32 fPI	= 3.1415926f;
		...
		public:
			...
			{
				AKASSERT( in_fInitialPhase >= -fPI && in_fInitialPhase < fPI );
			...
			inline void SetFrequency( AkReal32 in_fFrequency )
			{
				...
				m_fPhaseIncrement = fTWOPI * in_fFrequency / m_fSampleRate;
			}
