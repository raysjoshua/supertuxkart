    ...
    )
{
	...
	CAkStdStmBlocking * pNewStm = AkNew( AkMemID_Streaming, CAkStdStmBlocking() );
	...
	if ( !pNewStm )
	{
		...
		pNewStm = AkNew( AkMemID_Streaming, CAkStdStmBlocking() );
	}
    ...
    )
{
	...
	AKRESULT eResult;
    CAkAutoStmBlocking * pNewStm = AkNew( AkMemID_Streaming, CAkAutoStmBlocking() );
	...
	if ( !pNewStm )
	{
		...
		pNewStm = AkNew( AkMemID_Streaming, CAkAutoStmBlocking() );
	}
