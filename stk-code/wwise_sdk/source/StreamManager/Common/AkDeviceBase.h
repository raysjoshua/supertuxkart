...
namespace StreamMgr
{
    ...
    public:
        ...
        virtual AkStmStatus WaitForPendingOperation();
...
#define CHECK_BUFFERING_CONSISTENCY()
	...
	public:
		...
		virtual AKRESULT  SetMinTargetBufferSize(AkUInt32 in_uMinTargetBufferSize) override;
	...
	private:
		...
		AkUInt32 m_uMinTargetBufferSize;
		AkUInt8* m_pBuffer;
		AkUInt64 m_uSize;
